...
This file is part of the CMaNGOS Project. See [AUTHORS](doc/AUTHORS.md) file for Copyright information
...
## License
  ...
  You can find the full license text in the file [COPYING](doc/COPYING.md) delivered with this package.
